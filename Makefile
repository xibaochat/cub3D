...
SRCS_NAME = nb_read_from_buffer.c calculation_start_end_point.c  draw_sol.c \
			...
			change_shift_dir.c manage_key_code.c is_valida_map.c get_line.c\
			get_map_elem_path.c  save_bmp.c \
			draw_ceil.c integrate_map.c press.c get_texture_path.c show_cover.c\
			init_all_major_var.c insert_warn.c lose.c put_bar_to_win.c init_all_sprites.c \
			...
			set_curr_sprites_tex.c set_entity_hitpoints.c  \
			manage_damage.c init_enemy_die.c secret_door.c move_door.c \
			bmp.c  free_cub3d_var.c get_map_as_str.c get_player_direction.c \
			 init_program_var_to_null.c init_mutan.c sprite_calculation.c \
			...
			get_next_line_from_s.c check_invalid_alpha.c
